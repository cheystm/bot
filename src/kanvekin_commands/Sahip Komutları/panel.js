...
module.exports = {
    ...
    execute: async (client, message, args, kanvekin_embed) => {
        if (!kanvekin_config.botOwners.some(kanvekin => message.author.id == kanvekin)) return message.reply({ embeds: [kanvekin_embed
            .setDescription(`> **Komutu Kullanmak İçin Yetkin Bulunmamakta!**`)] }).sil(5);
        let secim = args[0];
...
client.on(Events.InteractionCreate, async (kanvekin) => {
    ...
    if (value == "buttonpanel") {
        kanvekin.message.delete();
        kanvekin.channel.send({
            "content": `> ${client.emoji("emote_value") !== null ? client.emoji("emote_value") : "🔹"} Aşağıdaki Menü Üzerinden Sunucu Hakkında\n> Veya Hesabınızla İlgili Bazı Bilgilere Ulaşabilirsiniz.`,
            "components": [{
                "type": 1, "components": [{
...
client.on(Events.InteractionCreate, async (kanvekin) => {
    ...
    if (value == "burcrolkur") {
        ...
        kanvekin.message.delete();
        kanvekin.channel.send({
            "content": `> ${client.emoji("emote_value") !== null ? client.emoji("emote_value") : "🔹"} Menü Üzerinden **Burç** Rolünüzü Alabilirsiniz.`,
            "components": [{
                "type": 1, "components": [{
        ...
        kanvekin.message.delete();
        kanvekin.channel.send({
            "content": `> ${client.emoji("emote_value") !== null ? client.emoji("emote_value") : "💖"} Menü Üzerinden **İlişki** Rolünüzü Alabilirsiniz.`,
            "components": [{
                "type": 1, "components": [{
        ...
        kanvekin.message.delete();
        kanvekin.channel.send({
            "content": `> ${client.emoji("emote_value") !== null ? client.emoji("emote_value") : "🎉"} Menü Üzerinden **Etkinlik** Rolünüzü Alabilirsiniz.`,
            "components": [{
                "type": 1, "components": [{
        ...
        kanvekin.message.delete();
        kanvekin.channel.send({
            "content": `> ${client.emoji("emote_value") !== null ? client.emoji("emote_value") : "🔹"} Menü Üzerinden **Renk** Rolünüzü Alabilirsiniz.`,
            "components": [{
                "type": 1, "components": [{
